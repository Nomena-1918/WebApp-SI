...
<html lang="en">
  ...
  <div id="popup-container" class="popup-container" style="display: none;">
    ...
    <div class="mb-0 text-muted">
        <a class="dropdown-item" href="<?php echo site_url('sport/get_all_sport'); ?>">Liste des activités sports</a>
      </div>
      <main role="main" class="main-content">
    <div class="mb-0 text-muted">
        <a class="dropdown-item" href="<?php echo site_url('plat/create_plat'); ?>">Créer un plat</a>
      </div>
            ...
            <div class="col-12">
              <div class="row">
                ...
                <div class="col-md-12 my-4">
                  <h2 class="h4 mb-1">Liste des plats</h2>
                  <p class="mb-3">Voici tous les plats que vous avez crée</p>
                  <div class="card shadow">
                    <div class="card-body">
                      ...
                      <table class="table table-borderless table-hover">
                        ...
                        <tbody>
                        <?php foreach ( $plats->result_array() as $row) { ?>
                          <tr>
                            <td>
                              <div class="avatar avatar-md">
                                <img src="<?php echo base_url("assets/allplat/assets/images/Sakafo_sary/"  . $row["picture"] ); ?>" alt="..." class="avatar-img rounded-circle"">
                              </div>
                            </td>
                            <td> <p class="mb-0 text-muted"><strong><?php echo $row['nom'];  ?></strong></p> </td>
                            <td> <p class="mb-0 text-muted"><strong><?php echo $row['calorie'];  ?></strong></p>  </td>
                            <td> <p class="mb-0 text-muted"><strong><?php echo $row['prix'];  ?></strong></p> </td>
                            <td><button class="btn btn-sm dropdown-toggle more-horizontal" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="">Action</span>
                              </button>
                              <div class="dropdown-menu dropdown-menu-right">
                                <a class="dropdown-item" href="<?php echo site_url('plat/get_platBy_id/'.$row['id']);?>">Edit</a>
